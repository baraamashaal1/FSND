...
```
- Returns: return creation status.
 ```
{
...
```
- Returns: returns questions that has the search Term.
 ```
{
  "questions": [
    {
...
- Request Arguments: None
- Returns: return list of questions by category.
 ```
{
...
#### `POST /quizzes`
- make a quiz of questions
- Request Arguments: Takes the category and previous questions in the request.
```
{
   "previous_questions":[
...
```
- Returns: Return random question not in previous questions.
 ```
{
  "question": {
    "answer": "test Answer.", 
